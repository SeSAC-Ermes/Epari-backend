...
public enum ErrorCode {
	...
	NOTIFICATION_TEMPLATE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "NTF-002", "알림 템플릿 처리 중 오류가 발생했습니다."),
	SES_SERVICE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "NTF-003", "이메일 서비스 연동 중 오류가 발생했습니다.");
