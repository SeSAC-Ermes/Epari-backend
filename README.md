...
<div align="center">
  <img src="https://github.com/user-attachments/assets/080c8ad6-72a1-4f11-bc9b-89246a03f784" width="100000">
</div>
...
| 이름     | 역할                          | 기여 내용                                                                                   | GitHub                         |
| -------- | ----------------------------- | ------------------------------------------------------------------------------------------ | ------------------------------ |
| 오찬근   | **팀장** <br> 풀스택 <br> 인프라 | • 인프라 구축 <br> • 관리자 기능 구현 <br> • 출결, 커리큘럼 관리 기능 구현 <br> • 자동화 워크플로우 구현 <br> • AI 챗봇 구현 | https://github.com/Chan-GN    |
| 박종호   | 풀스택                        | • 엔티티 설계 <br> • 강의 기능 구현 <br> • 시험 화면 구현 <br> • 커뮤니티 기능 구현 <br> • 관리자 대시보드 구현 | https://github.com/cuteJJong  |
| 임진희   | 풀스택 <br> 인증/인가          | • 사용자 인증/인가 <br> • 마이페이지 구현                                                  | https://github.com/liimjiin   |
| 임혜린   | **부팀장** 풀스택 <br> 인프라  | • 인프라 구축 <br> • 시험 기능 구현 <br> • 커뮤니티 기능 구현 <br> • 관리자 대시보드 구현 <br> • AI 챗봇 구현 | https://github.com/hyerin315  |
